...
> 자율주행 차량(AV)이 주변 환경을 관측하고 행동할 수 있도록 **POMDP 구조 설계**
...
SUMO에서 일반 차량의 주행 성향을 바꾸고 싶다면 다음과 같은 값을 조절할 수 있습니다.
...
차량마다 다른 설정을 주면 더 다양한 교통 흐름도 만들 수 있습니다.
